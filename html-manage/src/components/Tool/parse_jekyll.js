	...
	<div id="import_jekyll_app" style="margin-top: 30px;">
		<div class="col-md-4">
			...
			<div style="margin: 10px 0 10px 10px;">
				<button class="btn btn-primary" onclick="start_import_data();">Import ${select_count} posts</button>
				to
...
var analysis_post = function(data, file){
	try{
		...
		for (var i = files.length - 1; i >= 0; i--) {
			...
			reader.onload = (function(file) {
				return function(event){
					var re = analysis_post(event.target.result, file);
					if(re && re['content']){
...
var start_import_data = function(){
...
$.ajax({
			...
			dataType: 'json',
			data: {
				'title': 'testdddddddddddddddddddddddddddddddddddddddddddddddddddddd',
				...
				'last_modified_time': '2017-01-01T10:04:04.502967Z',
			},
			success: function(data){
				console.log(data);
			},
