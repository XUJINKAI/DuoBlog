# -*- coding: utf-8 -*-
'''
魔改, accept "a, b, c" or "['a', 'b', 'c']"

https://github.com/glemmaPaul/django-taggit-serializer
use TagListSerializerField as tags field, 
and inherit TaggitSerializer for serializer
'''
import json
...
class TagListSerializerField(serializers.Field):
	...
	def __init__(self, format_string=False, **kwargs):
