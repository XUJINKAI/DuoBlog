...
urlpatterns = [
	...
	url(r'^posts/create/$', views.manage_view, {'page': 'posts_create'}, name='post_create'),
	url(r'^pages/$', views.pages_view, name='pages'),
	url(r'^pages/create/$', views.pages_edit_view, name='page_edit'),
	url(r'^pages/edit/(?P<page_pk>\d+)/$', views.pages_edit_view, name='page_edit'),
